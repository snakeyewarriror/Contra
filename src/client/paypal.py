...
async def cancel_subscription(access_token: str, subscription_id: str, reason = 'Not specified'):
...
async def cancel_subscription( access_token: str, subscription_id: str, reason = 'Not specified'):
    ...
    print(f"[+] Update data: {cancel_data}\n")
    
        

async def update_subscription( access_token: str, subscription_id: str, new_plan_id: str,
...
async def get_subscription_details(access_token: str, subscription_id: str) -> dict:
